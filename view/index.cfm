    ...
    <body>
        ...
        <div class="container-fluid-parent container-fluid-page">
            <cfif StructKeyExists(URL, "q") AND URL.q NEQ ''>
                ...
                <cfset VARIABLES.products = VARIABLES.productCFC.hasProducts(URL.q) />
                <cfoutput>
                                ...
                                <div class="filters">
                                    <div class="filter filter-Category">
                                        ...
                                        <form id="category-checkbox">
                                            <cfset VARIABLES.subCategoryFilters = VARIABLES.productCFC.filterSubCategories(URL.q) />
        ...
        <cfinclude template = "/commons/footer.cfm">
            ...
            <form method="post">
                <button type = "submit" name="xyz">decrease session timeout</button>
            </form>
            <cfif structKeyExists(FORM, "xyz")>
